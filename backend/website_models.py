...
# Admin roles: superadmin | admin | coordinator | finance | communication
class Admin(db.Model):
    ...
    role            = db.Column(db.String(50), default='admin')  # superadmin | admin | coordinator | finance | communication
...
# Member category: Church Leader | Pastor | Village Elder | Agent | Youth Leader |
...
class Member(db.Model):
    ...
    created_by        = db.Column(db.String(20), default='self')       # self | admin
...
class Payment(db.Model):
    ...
    payment_type   = db.Column(db.String(50), nullable=False)  # Donation | Contribution | Welfare Fund
